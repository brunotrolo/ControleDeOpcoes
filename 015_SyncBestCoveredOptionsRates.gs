 ...
 *   001 → SYS_CONFIG.SHEETS.BEST_RATES + SYS_CONFIG.SHEETS.RANK_M9M21
 *   003 → Sanitizador.numeroPuro() / textoPuro() / dataPura() / dataSoData()
...
const BEST_RATES_CONFIG = {
  SHEET_NAME: SYS_CONFIG.SHEETS.BEST_RATES,
 ...
 * que ja existe na planilha (sincronizada pelo modulo 017).
